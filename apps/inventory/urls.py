...
urlpatterns = [
    ...
    path("api/categories/<int:pk>/update/", views.CategoryUpdateAPI.as_view(), name="api_category_update"),
    path("api/categories/<int:pk>/delete/", views.CategoryDeleteAPI.as_view(), name="api_category_delete"),
